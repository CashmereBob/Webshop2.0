...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <h3>Kunduppgifter</h3>
     <h4><asp:Label ID="Label_company" runat="server" Text="company"></asp:Label></h4></h4><asp:TextBox ID="TextBox_company" runat="server"></asp:TextBox>
      <h4><asp:Label ID="Label_firstname" runat="server" Text="firstname"></h4></asp:Label><asp:TextBox ID="TextBox_firstname" runat="server"></asp:TextBox>
          <h4><asp:Label ID="Label_lastname" runat="server" Text="lastnamename"></h4></asp:Label><asp:TextBox ID="TextBox_lastname" runat="server"></asp:TextBox>
      ...
      <h4><asp:Label ID="Label_postalcode" runat="server" Text="postalcode"></h4></asp:Label><asp:TextBox ID="TextBox_postalcode" runat="server"></asp:TextBox> 
