    ...
    <div class="container-fluid">
        ...
        <div class="jumbotron">
            ...
            <div class="row">
                <%-- IMG --%>
                <div class="col-md-3">
                    <asp:Image CssClass="img-responsive img-rounded" ID="Image_Product" ImageUrl="http://lundgren84.com/Grupp7/KlädPlagg.jpg" AlternateText="Product Img" runat="server" />
                </div>
            </div>
            <div class="row">
