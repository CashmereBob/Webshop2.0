<%@ Page Title="Edit Order" Language="C#" MasterPageFile="~/Admins.Master" AutoEventWireup="true" CodeBehind="Edit_Order.aspx.cs" Inherits="WebShop_Group7.Admin.Edit_Order" %>
 ...
 <asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h3>Kunduppgifter</h3>
      <h4><asp:Label ID="Label_firstname" runat="server" Text="firstname"></asp:Label></h4>
      <h4><asp:Label ID="Label_lastname" runat="server" Text="lastnamename"></asp:Label></h4>
      <h4><asp:Label ID="Label_adress" runat="server" Text="adress"></asp:Label></h4>
      <h4><asp:Label ID="Label_postalcode" runat="server" Text="postalcode"></asp:Label></h4>
      <h4><asp:Label ID="Label_city" runat="server" Text="city"></asp:Label></h4>
     </br>
...
<asp:DataList ID="DataList_PruductsInOrder" runat="server">
     ...
     <h3>Frakt</h3>
     <h4><asp:Label ID="Label_Carrier" runat="server" Text="Fraktmetod"></asp:Label></h4>
     <h3>Payment</h3>
     <h4><asp:Label ID="Label_Payment" runat="server" Text="Payment"></asp:Label></h4>
